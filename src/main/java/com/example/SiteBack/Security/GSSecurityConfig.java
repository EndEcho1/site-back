...
import module spring.boot.starter.security;
...
/**
    @Bean
    public SecurityFilterChain(HttpSecurity echo) throws Exception{
...
public SecurityFilterChain BaSecurityFilterChain(HttpSecurity http) throws Exception {
    http
            .authorizeHttpRequests(authorize -> authorize
                    .requestMatchers("/auth/**", "/", "/loginfail").permitAll() // 允许所有人访问
